...
import SearchAndFilter from '@/components/searchui';
    ...
    <div className="mx-9 overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mr-5 max-sm:gap-8 ml-6 my-6">
        ...
        <div className="justify-center items-center my-9 ">
          <Link href="/shop">
            <button className="border border-yellow-500 hover:bg-yellow-600 font-semibold py-1 px-2 rounded-sm shadow-md hover:shadow-lg hover:scale-110 justify-center items-center lg:ml-96 transition-transform duration-200 ease-in-out w-44 h-10">
              Show More
            </button>
          </Link>
        </div>
